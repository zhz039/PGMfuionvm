...
ha = tightPlots(2, 2, 20, [2 2], [1.0 0.8], [3 1.5], [2.5 3], 'centimeters');
fontsize = 12;
...
% (b)
axes(ha(2));
I1 = imgaussfilt(I_overlap,8);
imagesc(I1,'XData', [min_lon, max_lon], 'YData', [max_lat, min_lat]); hold on;
set(gca,'colormap',flipud(jet));
set(gca,'YDir','normal');
set(gca,'clim',[1.5,3.5]);
set(gca, 'xtick',0:50:100);
...
% set(gca,'xticklabel',[])
% set(gca,'yticklabel',[])
xlabel(['West-East (km)', newline, '\bf (c)']);
ylabel('South-North (km)');
set(gca,'colormap',flipud(jet));
set(gca,'FontSize',fontsize);
set(gca,'TickDir','out');
...
% set(gca,'xticklabel',[])
set(gca,'yticklabel',[])
xlabel(['West-East (km)', newline, '\bf (d)']);
% ylabel('South-North (km)');
set(gca,'colormap',flipud(jet));
set(gca,'FontSize',fontsize);
set(gca,'TickDir','out');
